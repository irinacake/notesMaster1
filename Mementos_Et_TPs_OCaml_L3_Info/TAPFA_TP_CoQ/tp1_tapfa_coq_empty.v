...
Fixpoint factorielle
(* ... (à compléter) *)
end.

(* calculer "factorielle 3" *)
(* ... (à compléter) *)
...
Definition ex1 : A -> B -> A :=

Definition ex2 : A -> B -> B :=

Definition ex3 : A -> (A -> B) -> B :=

Definition ex4 : (A -> B) -> (B -> C) -> A -> C :=

Definition ex5 : (A -> B) -> (A -> B -> C) -> A -> C :=
